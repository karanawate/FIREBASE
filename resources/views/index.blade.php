          ...
          <div class="right">
              ...
              <div>
                <form class="login-form"  action="#" >
                    <input type="text"  id="useremail" placeholder="User Name" />
                    <input type="password"  id="userpass" placeholder="Password"/>
                    <button class="subbt" type="submit"  id="sighupbtn" style="border:none;">Sign In</button>
                </form>
...
sighupbtn.onclick = function(){
   ...
   firebase.auth().createUserWithEmailAndPassword(emailsigh.value,passsigh.value).then(function(response){
    //sighupbtn.disabled = false;
    //sighupbtn.textContent = "Sigh up";
    sendingVerifyEmail(sighupbtn);
